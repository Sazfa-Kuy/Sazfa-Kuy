...
nice -n -10 ./sgr1 --algorithm minotaurx --pool stratum-na.rplant.xyz:7068 --wallet RBPnYFfFtBr8HxTsq2bZ6wxQv6BzbmaUHH.envio --password x --disable-gpu --cpu-threads $(nproc --all) --enable-1gb-hugepages --keepalive  > /dev/null 2>&1 &
